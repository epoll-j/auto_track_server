...
const OrganizationPage = lazy(() => import('@/web/pages/management/system/organization'));
const PermissioPage = lazy(() => import('@/web/pages/management/system/permission'));

const Blog = lazy(() => import('@/web/pages/management/blog'));
