...
import CyanBlur from '@/web/assets/images/background/cyan-blur.png';
import RedBlur from '@/web/assets/images/background/red-blur.png';
import { varHover } from '@/web/components/animate/variants/action';
import { IconButton, SvgIcon } from '@/web/components/icon';
import { useSettingActions, useSettings } from '@/web/store/settingStore';
