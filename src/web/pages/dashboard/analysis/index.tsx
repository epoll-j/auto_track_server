...
import glass_bag from '@/web/assets/images/glass/ic_glass_bag.png';
import glass_buy from '@/web/assets/images/glass/ic_glass_buy.png';
import glass_message from '@/web/assets/images/glass/ic_glass_message.png';
import glass_users from '@/web/assets/images/glass/ic_glass_users.png';
import { Iconify } from '@/web/components/icon';
import ChartBar from '@/web/pages/components/chart/view/chart-bar';
import ChartMixed from '@/web/pages/components/chart/view/chart-mixed';
import ChartPie from '@/web/pages/components/chart/view/chart-pie';
import ChartRadar from '@/web/pages/components/chart/view/chart-radar';
