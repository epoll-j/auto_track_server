...
import DashboardImg from '@/web/assets/images/background/dashboard.png';
import Overlay2 from '@/web/assets/images/background/overlay_2.jpg';
import LocalePicker from '@/web/components/locale-picker';
import { useUserToken } from '@/web/store/userStore';
