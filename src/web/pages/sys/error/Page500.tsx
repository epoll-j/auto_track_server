...
import Character8 from '@/web/assets/images/characters/character_8.png';
import MotionContainer from '@/web/components/animate/motion-container';
import { varBounce } from '@/web/components/animate/variants/bounce';
